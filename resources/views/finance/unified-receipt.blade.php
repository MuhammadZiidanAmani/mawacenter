...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .receipt-actions button, .receipt-actions a { min-height: 40px; padding: 0 16px; display: inline-flex; align-items: center; justify-content: center; color: #0d5f36; background: #f3fbf6; border: 1px solid #b9dcc7; border-radius: 8px; cursor: pointer; font: inherit; font-weight: 700; text-decoration: none; }
        ...
        .receipt-title p { margin: .4mm auto 0; max-width: 160mm; font-size: 12px; line-height: 1.25; word-break: break-word; }
        ...
        th, td { min-height: 6.2mm; padding: .9mm 1.4mm; border: 1px solid #555; text-align: left; font-size: 13px; line-height: 1.22; vertical-align: middle; }
