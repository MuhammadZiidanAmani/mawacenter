        ...
        <main class="finance-page">
            ...
            <div>
                ...
                <section class="card master-card spp-history other-payment-history">
                    ...
                    <div class="table-wrap"><table @class(['data-table', 'spp-list-table', 'registration-payment-table' => $paymentSection['key'] === 'daftar-ulang'])><thead><tr><th>No</th><th>NIS</th><th>Nama</th><th>Unit Pendidikan</th><th>Kelas</th><th>Cara Bayar</th><th>Total</th><th></th></tr></thead><tbody>
